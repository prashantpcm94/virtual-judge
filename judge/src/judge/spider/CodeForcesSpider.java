...
public class CodeForcesSpider extends Spider {
	...
	public void crawl() throws Exception{
		...
		description.setDescription(Tools.regFind(html, "standard output</div></div><div>([\\s\\S]*?)</div><p</p><p</p><div class=\"input-specification"));
		description.setInput(Tools.regFind(html, "<div class=\"section-title\">Input</div>([\\s\\S]*?)</div><p</p><p</p><div class=\"output-specification\">"));
		description.setOutput(Tools.regFind(html, "<div class=\"section-title\">Output</div>([\\s\\S]*?)</div><p</p><p</p><div class=\"sample-tests\">"));
		...
		description.setHint(Tools.regFind(html, "<div class=\"section-title\">Note</div>([\\s\\S]*?)</div></div><p> </p>"));
