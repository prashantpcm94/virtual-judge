	...
	<body>
		...
		<table width="100%" border="0" class="banner">
			<tr>
				...
				<td>
					<a href="contest/toListContest.action">Contests</a>
				</td>
				<td>
					<a href="contest/viewContest.action?cid=${cid}">Problems</a>
				</td>
				<td>
					<a href="contest/status.action?cid=${cid}">Status</a>
				</td>
				<td>
					<a href="contest/standing.action?cid=${cid}">Standing</a>
				</td>
				<td>
